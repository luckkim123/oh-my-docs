...
CHECKPOINT = (
    ...
    "inspect(형성적 검토) / verify(총괄 검증) / convert(포맷·납품 변환) / translate(재목적화·번역) / "
    "revise(통과까지 루프), 또는 docs-pilot(통째).\n"
    ...
    "STAGE(docs) → <intake|standardize|plan|build|inspect|verify|convert|translate|revise|learn|docs-pilot> · <pptx|docx|xlsx|hwpx|repo-docs|site> · <한 줄 근거>\n"
